...
import { Bot, Home, Images, Key, Menu, Plus, Redo2, Trash2, Undo2, Upload } from "lucide-react";
...
export function CanvasTopBar({ title, titleDraft, isTitleEditing, onTitleDraftChange, onStartTitleEditing, onFinishTitleEditing, onCancelTitleEditing, canUndo, canRedo, onHome, onProjects, onCreateProject, onDeleteProject, onImportImage, onUndo, onRedo, agentOpen, onToggleAgent }: CanvasTopBarProps) {
